      ...
      <div className="space-y-4">
          ...
          >
              ...
              <div className="text-left flex-1">
                  <div className="flex items-center gap-2">
                      <h3 className="font-bold text-foreground text-base">Telegram Chat</h3>
                      <ExternalLink size={14} className="text-muted-foreground" />
                  </div>
                  <p className="text-xs text-muted-foreground mt-0.5">Найшвидший спосіб отримати відповідь</p>
              </div>
          </motion.button>
          ...
          >
              <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                      <h3 className="font-bold text-foreground text-base">Email</h3>
                      <p className="text-xs text-muted-foreground mt-0.5">Для ділових пропозицій та скарг</p>
                  </div>
              </div>
